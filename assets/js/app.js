(function(){
  ...
  function rowTemplate(index){
    ...
    sel.required = true;
    sel.innerHTML = `<option value="">Seleccione...</option>` + products.map(p=>`<option value="${p.id}" data-precio="${p.precio}" data-stock="${p.stock}">${p.label}</option>`).join('');
    ...
    btn.addEventListener('click', ()=>{ tr.remove(); recalcTotal(); });
